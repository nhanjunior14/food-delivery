...
<body class="home">
    ...
    <section class="hero bg-image" data-image-src="./images/background/banner.jpg">
            ...
            <div class="container text-center hero-text font-white">
                ...
                <div class="steps">
                    ...
                    <div class="step-item step2">
                        ...
                        <h4><span style="color:white;">2. </span>Order Dishes</h4>
                    </div>
                    ...
                    <div class="step-item step3">
                        ...
                        <h4><span style="color:white;">3. </span>Package & Delivery</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2 class="text-danger">Popular Dishes of Restaurants</h2>
                <p class="lead">You can take a look at the TOP 9 dishes from the restaurants</p>
            </div>
            <div class="row">
                <?php 					
                        ...
                        echo '  
                            <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                <div class="food-item-wrap">
                                    <div class="figure-wrap bg-image" data-image-src="./images/dishes/'.$r['image'].'"></div>
                                    <div class="content">
                                        <h5 class="content-hidden"><a href="dishes.php?res_id='.$r['restaurant_id'].'">'.$r['title'].'</a></h5>
                                        <div class="product-name">'.$r['dsc'].'</div>
                                        <div class="price-btn-block"> 
                                            <span class="price">$'.$r['price'].'</span> 
                                            <a href="dishes.php?res_id='.$r['restaurant_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <p>Here you can choose the restaurant that suits your goals.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Order Dishes</h3>
                            <p>Here you can choose your favorite dishes from the restaurant you previously selected.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <p>After choosing a dish from the restaurant, they will prepare to package and send your order!</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <ul>
                                ...
                                <?php 
                                    ...
                                    while($row = mysqli_fetch_array($res)) {
                                        echo '
                                            <li><a href="#" data-filter=".'.$row['name'].'"> '.$row['name'].'</a></li>
                                        ';
                                    }
								?>
                            </ul>
                ...
                <div class="restaurant-listing">
                    <?php  
                        ...
                        while($rows = mysqli_fetch_array($ress)) { 
                            $query = mysqli_query($db,"select * from category where category_id = '".$rows['category_id']."'");
                            $rowss = mysqli_fetch_array($query);

                            echo ' 
                                <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant all '.$rowss['name'].'">
                                    <div class="restaurant-wrap">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                                                <a class="restaurant-logo" href="dishes.php?res_id='.$rows['restaurant_id'].'"> 
                                                    <img src="./images/restaurant/'.$rows['image'].'" alt="Restaurant logo"> 
                                                </a>
                                            </div>
                                            <div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
                                                <h5><a href="dishes.php?res_id='.$rows['restaurant_id'].'">'.$rows['title'].'</a></h5> <span>'.$rows['address'].'</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
