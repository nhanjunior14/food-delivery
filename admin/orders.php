                            ...
                            <div class="card card-outline-primary">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                                $sql = "SELECT users.*, orders.* FROM users INNER JOIN orders ON users.user_id = orders.user_id";
                                            ...
                                            ?>
                                                                <td> 
                                                                    <button type="button" class="btn btn-primary"><span class="fa fa-check-circle" aria-hidden="true"></span> Delivered</button>
                                                                </td>
                                            <?php 
                                                            } 
                                            ?>
                                            ...
                                            <?php
                                                            echo '<a href="order_detail.php?user_upd='.$rows['order_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
                                                                </td>
                                                                </tr>';              
                                                    }	
                                                }
