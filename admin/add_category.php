<?php
    ...
    if(isset($_POST['submit'] )) {
        if(empty($_POST['c_name'])) {
            ...
            $check_cat = mysqli_query($db, "SELECT name FROM category where name = '".$_POST['c_name']."' ");
            ...
            if(mysqli_num_rows($check_cat) > 0) {
                ...
                $mql = "INSERT INTO category(name) VALUES('".$_POST['c_name']."')";
                mysqli_query($db, $mql);
            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> 
                            <a href="ausers.php"><span><i class="fa fa-user f-s-20"></i></span><span>Users</span></a>
                        </li>
                        <li> 
                                                ...
                                                while($rows = mysqli_fetch_array($query)) {
                                                    echo ' 
                                                        <tr>
                                                            ...
                                                            <td>'.$rows['date'].'</td>
                                                            <td>
                                                                <a href="delete_category.php?cat_del='.$rows['category_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
