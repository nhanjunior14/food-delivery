    ...
    if(isset($_POST['submit'])) {
        if(empty($_POST['uname']) || empty($_POST['fname']) || 
            ...
            if(!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
                ...
                $mql = "update users set username='$_POST[uname]', firstname='$_POST[fname]', lastname='$_POST[lname]', email='$_POST[email]', phone='$_POST[phone]', password='".md5($_POST['password'])."' where user_id='$_GET[user_upd]' ";
                mysqli_query($db, $mql);
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                ...
                                <div class="card-body">
                                    <?php 
                                        $ssql ="select * from users where user_id='$_GET[user_upd]'";
