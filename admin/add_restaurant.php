        ...
        if(empty($_POST['c_name']) || empty($_POST['res_name']) || 
            ...
            if($extension == 'jpg' || $extension == 'png' || $extension == 'gif' || $extension == 'jpeg') {        
                if($fsize >= 1000000) {
                    ...
                    $sql = "INSERT INTO restaurant(category_id,title,email,phone,url,open_hr,close_hr,open_days,address,image) VALUE('".$_POST['c_name']."','".$res_name."','".$_POST['email']."','".$_POST['phone']."','".$_POST['url']."','".$_POST['o_hr']."','".$_POST['c_hr']."','".$_POST['o_days']."','".$_POST['address']."','".$fnew."')";  // store the submited data ino the database :images
