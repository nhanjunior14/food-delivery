            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        <h2 class="text-primary" style="text-align: center; font-weight: 600">FastFood Admin</h2>
                    </a>
                </div>
                ...
                <div class="navbar-collapse">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="./images/user.png" alt="user" class="profile-pic" style="background: rgb(13, 110, 253)"/>
                        </a>
            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> 
                            <a href="users.php"><span><i class="fa fa-user f-s-20 "></i></span><span>Users</span></a>
                        </li>
                        <li> 
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="restaurant.php">All Restaurant</a></li>
                        ...
                        <li> 
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="dishes.php">All Menues</a></li>
                                <li><a href="add_dishes.php">Add Menu</a></li>
                            </ul>
                        </li>
                        <li> 
                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white">Order Detail</h4>
                                </div>
                                ...
                                <div class="table-responsive m-t-20">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        <tbody>
                                            <?php
                                                $sql = "SELECT users.*, orders.* FROM users INNER JOIN orders ON users.user_id = orders.user_id where order_id = '".$_GET['user_upd']."'";
                                ...
                                <div class="table-responsive m-t-20 btn-location" style="display: flex; justify-content: space-evenly;">
                                    <div>
                                        <a href="javascript:void(0);" onClick="popUpWindow('update_order.php?form_id=<?php echo htmlentities($rows['order_id']);?>');" title="Update order">
                                        <button type="button" class="btn btn-primary">Update Order Status</button></a>
                                    </div>
                                    <div>
                                        <a href="javascript:void(0);" onClick="popUpWindow('user_infor.php?newform_id=<?php echo htmlentities($rows['order_id']);?>');" title="Update order">
                                        <button type="button" class="btn btn-primary">User Information</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
