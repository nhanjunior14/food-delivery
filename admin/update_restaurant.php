<?php
    ...
    if(isset($_POST['submit'])) {
        if(empty($_POST['c_name']) || empty($_POST['res_name']) || 
            ...
            $store = "../images/restaurant/".basename($fnew);                   
            ...
            if($extension == 'jpg' || $extension == 'jpeg'|| $extension == 'png' || $extension == 'gif') {        
                if($fsize >= 1000000) {
                    ...
                    $sql = "UPDATE restaurant SET category_id = '$_POST[c_name]', title='$res_name', email='$_POST[email]', phone='$_POST[phone]', url='$_POST[url]', open_hr='$_POST[o_hr]', close_hr='$_POST[c_hr]', open_days='$_POST[o_days]', address='$_POST[address]', image='$fnew' WHERE restaurant_id = '$_GET[res_upd]' ";  // store the submited data ino the database :images mysqli_query($db, $sql); 
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> 
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="restaurant.php">All Restaurants</a></li>
                    ...
                    <div class="card card-outline-primary">
                        ...
                        <div class="card-body">
                            <form action='' method='post' enctype="multipart/form-data">
                                <div class="form-body">
                                    <?php 
                                        $ssql = "select * from restaurant where restaurant_id = '$_GET[res_upd]'";
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phone" class="form-control" value="<?php echo $row['phone']; ?>" placeholder="0333333333">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group has-danger">
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="restaurant.php" class="btn btn-inverse">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
