...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="inner-page-hero bg-image" data-image-src="./images/background/banner-rs.jpg">
                                        ...
                                        echo' 
                                            <div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
                                                <div class="entry-logo">
                                                    <a class="img-fluid" href="dishes.php?res_id='.$rows['restaurant_id'].'"> 
                                                        <img src="./images/restaurant/'.$rows['image'].'" alt="Food logo">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
                                                <div class="right-content bg-white">
                                                    <div class="right-review">
                                                        <a href="dishes.php?res_id='.$rows['restaurant_id'].'" class="btn btn-purple">View Menu</a> 
                                                    </div>
                                                </div>
                                            </div>
                                        ';
