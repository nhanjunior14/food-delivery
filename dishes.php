...
<body>
    ...
    <div class="page-wrapper">
        ...
        <?php 
            $ress = mysqli_query($db,"select * from restaurant where restaurant_id='$_GET[res_id]'");
            $rows = mysqli_fetch_array($ress);								  
        ?>
        <section class="inner-page-hero bg-image" data-image-src="./images/background/banner-rs.jpg">
            <div class="profile">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 profile-img">
                            <div class="image-wrap">
                                <figure><?php echo '<img src="./images/restaurant/'.$rows['image'].'" alt="Restaurant logo">'; ?></figure>
                            </div>
                        </div>
                            ...
                            <div class="widget-body">
                                <?php
                                    ...
                                    ?>
                                        <div class="title-row">
                                            <?php echo $item["title"]; ?>
                                            <a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["dishes_id"]; ?>">
                ...
                <div class="col-md-8">
                    <div class="menu-widget" id="2">
                        ...
                        <div class="collapse in" id="popular2">
                            <?php  
                                $stmt = $db->prepare("select * from dishes where restaurant_id = '$_GET[res_id]'");
                                $stmt->execute();
                                        ...
                                        <div class="food-item">
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-lg-8">
                                                    <form method="post" action='dishes.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['dishes_id']; ?>'>
                                                        <div class="rest-logo pull-left">
                                                            <a class="restaurant-logo pull-left" href="#"><?php echo '<img src="./images/dishes/'.$product['image'].'" alt="Food logo">'; ?></a>
                                                        </div>
                                                        <div class="rest-descr">
                                                            <h6><a href="#"><?php echo $product['title']; ?></a></h6>
                                                            <p><?php echo $product['dsc']; ?></p>
                                                        </div>
                                                </div>
