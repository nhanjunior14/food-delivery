                                            ...
                                            if(!mysqli_num_rows($query_res) > 0 ) {
                                                ...
                                                ?>
                                                        ...
                                                        <td data-column="Action"> 
                                                            <a href="delete_orders.php?order_del=<?php echo $row['order_id'];?>" onclick="return confirm('Are you sure you want to cancel your order?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10">
